...
const Header = () => {
  ...
  return (
    <>
      <header
       className={`header left-0 top-0 z-40 flex w-full items-center bg-[#202a39]  text-white ${
        sticky
          ...
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="flex w-full items-center justify-between px-4">
              <div>
                ...
                <nav
                  id="navbarCollapse"
                  className={`navbar absolute right-0 z-30 w-[250px] rounded border-[.5px] border-body-color/50 bg-[#202a39] px-6 py-4 duration-300 dark:border-body-color/20 dark:bg-dark lg:visible lg:static lg:w-auto lg:border-none lg:!bg-transparent lg:p-0 lg:opacity-100 ${
                    navbarOpen
                          ...
                          <Link
                            ...
                            className={`flex py-2 text-base lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 ${
                              usePathName === menuItem.path
                                ...
                                : "text-dark hover:text-primary text-white/70 dark:hover:text-white"
                            }`}
                          >
                            {menuItem.title}
                          </Link>
