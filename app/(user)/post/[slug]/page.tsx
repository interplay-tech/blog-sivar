...
import TagButton from "@/components/components/Blog/TagButton";
import SharePost from "@/components/components/Blog/SharePost";
import author from "@/sanity/schemaTypes/author";
import {PortableText} from "@portabletext/react";
import { RichTextComponents } from "@/components/components/RichTextComponents";
              ...
              <div>
                ...
                <div className="mb-10 flex flex-wrap items-center justify-between border-b border-body-color border-opacity-10 pb-4 dark:border-white dark:border-opacity-10">
                  ...
                  <div className="mb-5">
                    <a
                      href="#0"
                      className="inline-flex items-center justify-center rounded-full bg-[#060c1f] px-4 py-2 text-sm font-semibold text-white"
                    >
                  ...
                  <div className="items-center justify-between sm:flex">
                    <div className="mb-5">
                      ...
                      <div className="flex items-center">
                        <TagButton text={post.categories[0].title} />
